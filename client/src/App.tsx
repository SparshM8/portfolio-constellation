/** Orbiting Archive design reminder: Sparsh Mishra’s recruiter-ready portfolio uses connected worlds, detailed case studies, and a living custom orbit cursor. */
...
export default function App(){return <ErrorBoundary><ThemeProvider defaultTheme="dark"><TooltipProvider><Toaster/><ConstellationCursor/><RouteTransition><Router/></RouteTransition></TooltipProvider></ThemeProvider></ErrorBoundary>}
