...
export default function App(){return <ErrorBoundary><ThemeProvider defaultTheme="dark" switchable><TooltipProvider><Toaster/><ConstellationLoader/><ConstellationCursor/><ThemeToggle/><RouteTransition><Router/></RouteTransition></TooltipProvider></ThemeProvider></ErrorBoundary>}
