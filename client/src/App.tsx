/** Orbiting Archive design reminder: Sparsh Mishra’s recruiter-ready portfolio uses persistent light/dark field states and globally connected navigation. */
...
export default function App(){return <ErrorBoundary><ThemeProvider defaultTheme="dark" switchable><TooltipProvider><Toaster/><ConstellationCursor/><ThemeToggle/><RouteTransition><Router/></RouteTransition></TooltipProvider></ThemeProvider></ErrorBoundary>}
