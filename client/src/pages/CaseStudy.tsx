...
export default function CaseStudy() {
  ...
  return <article className={`case-study case-study--${world.slug}`} style={{ "--case-accent": world.accent } as React.CSSProperties}>
    ...
    <footer className="case-footer"><span>SPARSH MISHRA / INDEPENDENT DESIGNER & CREATIVE TECHNOLOGIST</span><a href="mailto:sparsh@constellation.studio">SPARSH@CONSTELLATION.STUDIO</a></footer>
  </article>;
}
