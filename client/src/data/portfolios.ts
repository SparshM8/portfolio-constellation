...
export const portfolios: PortfolioWorld[] = [
  { id: "kinetic", number: "01", slug: "kinetic", title: "Kinetic", discipline: "Brand Designer / Art Director", caption: "Type that refuses to sit still.", description: "A poster-first portfolio for identity systems with enough voltage to make brands feel physical.", accent: "#ff5b2e", dark: false, mode: "kinetic", coordinate: "12° 48′ 31″ N", image: "/manus-storage/kinetic-world_123895a0.jpg", imageAlt: "Layered orange and black typographic poster composition for the Kinetic portfolio design.", tags: ["IDENTITY", "CAMPAIGN", "SYSTEMS"], cases: [{ title: "Ritual Frequency", type: "Cultural identity", year: "2026" }, { title: "Off-Grid Studio", type: "Launch campaign", year: "2025" }, { title: "Motion Matter", type: "Editorial system", year: "2024" }] },
  { id: "architect", number: "02", slug: "architect", title: "Architect", discipline: "Product & Experience Designer", caption: "Systems with a sense of space.", description: "A modular blueprint for digital products, spatial interfaces, and the decisions that make them intuitive.", accent: "#48d8d0", dark: false, mode: "architect", coordinate: "05° 14′ 09″ S", image: "/manus-storage/architect-world_be220300.jpg", imageAlt: "Aqua blueprint-style spatial product illustration for the Architect portfolio design.", tags: ["PRODUCT", "RESEARCH", "PROTOTYPE"], cases: [{ title: "Pulse Atlas", type: "Health platform", year: "2026" }, { title: "Common Room", type: "Community product", year: "2025" }, { title: "Field Objects", type: "Spatial interface", year: "2024" }] },
  { id: "void", number: "03", slug: "void", title: "Void", discipline: "Motion Designer / Storyteller", caption: "A dark room for moving images.", description: "A cinematic showreel space where the motion language has weight, light, and room to breathe.", accent: "#9d72ff", dark: true, mode: "void", coordinate: "88° 03′ 14″ E", image: "/manus-storage/void-world_bc8ff0e6.jpg", imageAlt: "Abstract violet light and dark circular motion study for the Void portfolio design.", tags: ["TITLE", "3D", "FILM"], cases: [{ title: "Still Becoming", type: "Title sequence", year: "2026" }, { title: "Luma Archive", type: "Launch film", year: "2025" }, { title: "Soft Machinery", type: "Motion identity", year: "2024" }] },
