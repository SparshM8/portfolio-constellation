...
- [x] Detect and adopt the visitor’s OS color preference on first load while preserving a manually chosen field mode.
- [x] Add a smooth reduced-motion-safe fade transition when Light Field and Dark Field are switched.
